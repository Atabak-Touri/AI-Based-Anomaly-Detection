...
The data was collected by Joanna Sendorek et al. for 3D printing anomalies detection. The data was collected during 3D printing process where several types of
annomalies were provoked and includes the temperature of working elements of the printer, instruction force and the acceleration of printing head. The 3D printer used to
